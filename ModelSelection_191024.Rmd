...
#Load data
```{r LoadData}
Data <- data.frame(read.table(file = "/Users/Chris/Desktop/UniversityofPittsburgh/Teaching/STAT2131/Lectures/110217-ModelSelectionII/Boston.txt", header = T, sep = "\t", stringsAsFactors = F))
